...
In this guide we'll be using the [vote-helm](https://github.com/garden-io/garden/tree/v0.11.0/examples/vote-helm) project. If you prefer to just check out a complete example, the project itself is also a good resource.
...
_[kubernetes-module](https://github.com/garden-io/garden/tree/v0.11.0/examples/kubernetes-module) example for more info._
...
Also check out the [kubernetes-module](https://github.com/garden-io/garden/tree/v0.11.0/examples/kubernetes-module)
